...
with open('/content/drive/MyDrive/Colab Notebooks/bert_bilstm_crf_named_entity_recognition/BERT-NER/input/excel_data/ner_dataset.json', encoding='utf-8') as f:
    raw = json.load(f)
